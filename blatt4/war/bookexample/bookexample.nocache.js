...
(function($wnd, $doc){
  ...
  var badBrowser = 'Unable to load Super Dev Mode of "bookexample" because\n';
  ...
  $wnd.__gwt_activeModules['bookexample'] = {
    'moduleName' : 'bookexample',
    'bindings' : function() {
      return {};
    }
  };
 ...
 * "/bookexample.nocache.js" is the one that loaded us. Normally this happens
...
function computeScriptBase() {
  ...
  $wnd.__gwt_activeModules['bookexample'].superdevmode = true;

  var expectedSuffix = '/bookexample.nocache.js';
  ...
  $wnd.alert('Unable to load Super Dev Mode version of ' + bookexample + ".");
}
;
  ...
  var devModeHookKey = '__gwtDevModeHook:bookexample';
  var devModeSessionKey = '__gwtDevModeSession:bookexample';

  // Compute some codeserver urls so as the user does not need bookmarklets
  var hostName = $wnd.location.hostname;
  var serverUrl = 'http://' + hostName + ':9876';
  var nocacheUrl = serverUrl + '/bookexample/bookexample.nocache.js';
  ...
  $wnd.__gwt_activeModules['bookexample'].canRedirect = true;
  $wnd.__gwt_activeModules['bookexample'].superdevmode = true;
  ...
  $wnd[compileFunction] = function() {
    ...
    compileScript.src = serverUrl +
      '/recompile/bookexample?user.agent=' + ua + '&_callback=' + callback;
