...
import movies.ui.views.RatedMoviesView;
 ...
 * 
 */
public class RatedMovieViewHandler extends AbstractHandler {
		...
		if (p != null) {
			...
			try {
				IViewPart view = PlatformUI.getWorkbench().getActiveWorkbenchWindow().getActivePage()
						.showView(RatedMoviesView.ID);
				if (view instanceof RatedMoviesView) {
					RatedMoviesView ratedMoviesView = (RatedMoviesView) view;
					ratedMoviesView.setInput(movies);
				}
