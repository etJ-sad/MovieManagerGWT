...
(function($wnd, $doc){
  ...
  var badBrowser = 'Unable to load Super Dev Mode of "nda" because\n';
 ...
 * "/nda.nocache.js" is the one that loaded us. Normally this happens
...
function computeScriptBase() {
  ...
  $wnd.__gwt_activeModules['nda'].superdevmode = true;

  var expectedSuffix = '/nda.nocache.js';
  ...
  $wnd.alert('Unable to load Super Dev Mode version of ' + nda + ".");
}
;
  ...
  var devModeHookKey = '__gwtDevModeHook:nda';
  var devModeSessionKey = '__gwtDevModeSession:nda';

  // Compute some codeserver urls so as the user does not need bookmarklets
  var hostName = $wnd.location.hostname;
  var serverUrl = 'http://' + hostName + ':9876';
  var nocacheUrl = serverUrl + '/nda/nda.nocache.js';
  ...
  $wnd.__gwt_activeModules['nda'].canRedirect = true;
  $wnd.__gwt_activeModules['nda'].superdevmode = true;
  ...
  $wnd[compileFunction] = function() {
    ...
    compileScript.src = serverUrl +
      '/recompile/nda?user.agent=' + ua + '&_callback=' + callback;
